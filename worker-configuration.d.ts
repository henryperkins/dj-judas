/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d9625c3fd145e867ebdd7882b0c9688e)
// Runtime types generated with workerd@1.20251011.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "RateLimiter" | "UserSession";
	}
	interface Env {
		SESSIONS: KVNamespace;
		RATE_LIMITER: DurableObjectNamespace<import("./src/worker/index").RateLimiter>;
		USER_SESSIONS: DurableObjectNamespace<import("./src/worker/index").UserSession>;
